...
class RegisterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //gesture.numberOfTouchesRequired = gesture.num
    ...
    override func viewDidLayoutSubviews() {
        ...
        firstNameField.frame = CGRect(x: 30, y: emailField.bottom + 15, width: scrollView.width - 60, height: 52)
        lastNameField.frame = CGRect(x: 30, y: firstNameField.bottom + 15, width: scrollView.width - 60, height: 52)
        passwordField.frame = CGRect(x: 30, y: lastNameField.bottom + 15, width: scrollView.width - 60, height: 52)
    ...
    @objc private func registerButtonTapped() {
        ...
        DatabaseManager.shared.userExists(with: email) { [weak self] exists in
            ...
            guard !exists else {
                ...
                strongSelf.alertUserLoginError(message: "Looks like a user account for this email adress aready exists")
                return
            }
